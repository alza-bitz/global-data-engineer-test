-- Test that raw_events_validated table has same row count as raw_events table
...
select 'Row count mismatch between raw_events and raw_events_validated' as test_failure
